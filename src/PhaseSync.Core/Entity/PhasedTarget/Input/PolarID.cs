...
{
    public sealed class PolarID : EntityInputEnvelope<IHoneyComb>
    {
        private const string KEY = "polarID";

        public PolarID(int id) : base(
            (comb) => comb.Props().Refined(KEY, new TextOf(id).AsString())
